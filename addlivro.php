    ...
    <main>
        <form class="formulario" enctype="multipart/form-data">
            ...
            <section>
                ...
                <input type="text" name="pais" placeholder="Nacionalidade" required><br>
                ...
                <input type="number" name="nivelDificuldade" placeholder="Nível de dificuldade (ex: 1 a 5)" required><br>
                <textarea name="textoDificuldade" placeholder="Texto sobre a dificuldade" required></textarea><br>

                <input type="date" name="dataLancamento" required><br><br>
