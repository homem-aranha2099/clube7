...
<?php
// Parte PHP: se foi feita uma requisição POST, retorna o JSON como download
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["json"])) {
    $dados = json_decode($_POST["json"], true);

    $nomeArquivo = preg_replace('/[^a-zA-Z0-9]/', '_', $dados["titulo"] ?? "livro") . ".json";
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <form action="index.html" method="post" id="formulario" enctype="multipart/form-data">
              ...
              <a href="a" class="btn btn-primary w-100"></a>
            </form>
          </div>
        </div>
      </div>
...
form.addEventListener("submit", function (e) {
  ...
  else {alert("Selecione pelo menos uma opção: estudo ou lazer.");return;}
